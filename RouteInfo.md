...
| /api/users/username/:id            | GET    | Get Single User data by passing username in                                       |
| /api/check-username/:id            | GET    | Checks whether the username already exists or not in database                    |
